...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'todomvc.com'
  config.app_name = 'Todomvc'
  config.mailer.from = 'Todomvc <no-reply@todomvc.com>'
  ...
  #
  config.app_secret = 'v2dmm2_agPOnVwgxLqN5xPygnHBIbjckcu8716fZf0zvWiVQhkEfhFRMIkaBfdSESck'
